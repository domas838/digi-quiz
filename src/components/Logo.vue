...
<template>
  <div class="brand-logo brand-logo--mobile">
    ...
    <img v-show="store.lang === 'LV' || store.flow === 'maths-quiz'" src="/src/assets/images/memby.svg" alt="Memby logo" />
    <img v-show="store.lang === 'EN_IE'" src="/src/assets/images/MathUps.svg" alt="MathsUp logo" />
    <img v-show="store.lang === 'EN_ZA' && store.flow !== 'maths-quiz'" src="/src/assets/images/MathsUp.svg" alt="MathsUp logo" />
  </div>
</template>
