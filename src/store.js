        ...
        EN_ZA: {
            ...
            parent: [
                ...
                },
                {
                    id: 'goal',
                    qNo: 3,
                    Q: "What is student's primary goal in math?",
                    Ans: [
                        {title: 'Improve Marks', img: '/emoji/🚀.svg'},
                        {title: 'Maintain High Marks', img: '/emoji/🤓.svg'},
                        {title: 'Test Prep', img: '/emoji/📝.svg'},
                ...
                { id: 'currentMark',
                    qNo: 7, Q: "Student’s Current Mark", Ans: [
                        {title: '100-90%'},
                        {title: '89-80%'},
                        {title: '79-70%'},
                        {title: '69-60%'},
                ...
                { id: 'targetMark',
                    qNo: 8, Q: "Student’s Target Mark?", Ans: [
                        {title: '100-90%'},
                        {title: '89-80%'},
                        {title: '79-70%'},
                        {title: '69-60%'},
                ...
                },
                {
                    id: 'expectations',
                    qNo: 15,
                    Q: 'As I progress I expect to feel:',
                    Ans: [
                        {title: 'Confident', img: '/emoji/😎.svg'},
                        {title: 'Happy', img: '/emoji/🤩_.svg'},
                        {title: 'Peaceful', img: '/emoji/😌.svg'},
                ...
                },
                {
                    id: 'sessions',
                    qNo: 16,
                    Q: 'How frequently and for what duration are student seeking tutoring sessions?',
                    Ans: [
                        {title: 'Daily', img: '/emoji/😎.svg'},
                        {title: 'Few times a week', img: '/emoji/🤩_.svg'},
                        {title: 'Weekends only', img: '/emoji/😌.svg'},
