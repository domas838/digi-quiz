...
const i18n = createI18n({
    ...
    messages: {
        ...
        en_za: {
            ...
            StudentRole: 'Student',
            ParentRole: 'Parent',
            EmailFormH1: 'We’ve created a personalised learning plan that will help you to achieve your goal and 7 day free trial account.',
            EmailFormWhereToSentResults: 'What email would you like to use to access it?',
            EmailFormWeWillRecommendPlan: 'We’ve created a personalised learning plan that will help you to achieve your goal and 7 day free trial account.',
            EmailFormYourEmail: 'Your email',
            EmailFormYourParentEmail: 'Email',
            EmailFormPrivacyNotice: 'Your personal data is safe with us. By the way, we do not send spam or share emails. email addresses with third parties.',
